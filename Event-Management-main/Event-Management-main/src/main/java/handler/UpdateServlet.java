...
public class UpdateServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		isTrue = HandlerfoodDButil.updateItem(id, name, qty, price, kitchen,cheff,supplier);
		
		if(isTrue == true) {
			RequestDispatcher dis = request.getRequestDispatcher("searchfood.jsp?successF=1");
