  ...
  <div id="sidebar">
   ...
   <div id="">
    ...
    <div class="subnav-content">
      <a id="sidebarSelected" href="Insertfood.jsp" style="text-decoration:none;">Food</a>
      <a href="Insertbeverage.jsp" style="text-decoration:none;">Beverage</a>        
   	</div>      
    	</div>
...
<!-- Gayan-->
 ...
 <div style="padding-left:5%;width:60%; float:left; ">
            <form action="Insertfood" id="frm" method="post">
	...
	try{ 
		...
		%>
                ...
                <input style="width:90%;" type="text" required id="txtQty"
                       name="txtQty" value="" placeholder="Type Item Quentity..">

                <br/>               
                <label style="width:60%;font-weight:bold;font-size:17px"> Price:</label> <br/>
            <input type="text" name="txtPrice" required value="" placeholder="Type Item Price.." id="txtPrice" style="width:90%;"><br/>
             <label style="width:60%;font-weight:bold;font-size:17px"> Kitchen ID:</label>
            <br>
           <input type="text" name="txtKitchen" required value="" id="txtKitchen" placeholder="Type Kitchen Id.." style="width:90%;"/>
            <br/>
 <label style="width:60%;font-weight:bold;font-size:17px"> Chef ID:</label>
            <br>
           <input type="text" name="txtcheff" required value="" id="txtcheff" placeholder="Type Chef's Id.." style="width:90%;"/>
                <br/>
             
                <label style="width:80%;font-weight:bold;font-size:17px">Supplier:</label>
                 <br/>
                <input style="width:90%;"  required value="" type="text" id="txtSupplier"
