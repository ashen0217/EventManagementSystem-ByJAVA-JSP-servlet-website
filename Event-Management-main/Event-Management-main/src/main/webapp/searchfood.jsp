...
<div id="container" style="height: 500px">
   ...
   <div>
    ...
    <div class="subnav-content">
      <a id="sidebarSelected" href="searchfood.jsp" style="text-decoration:none;">Food Stock</a>   
...
<td> 
 ...
 <a style="text-decoration:none;" href="updatefood.jsp?id=<%=resultSet.getString(1)%>&name=<%=resultSet.getString(2) %>&qty=<%=resultSet.getInt(3) %>&price=<%=resultSet.getInt(4)%>&kitchen=<%=resultSet.getString(5) %>&cheff=<%=resultSet.getString(6) %>&supp=<%=resultSet.getString(7)%>">
 <button type="button" name ="btn" class = "btnOrange" onClick="">Update</button>
 </a>
		
 </div>
 <div id="btnn3">
  <a style="text-decoration:none;" href="deletefood?id=<%=resultSet.getString(1)%>">
